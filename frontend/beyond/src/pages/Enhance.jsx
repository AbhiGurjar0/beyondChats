  ...
  const handleStartEnhancement = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `https://beyondchats-3.onrender.com/api/articles/${id}/generate`,
        {
          method: "POST",
          headers: {
      ...
      const intervalId = setInterval(async () => {
        try {
          let statusResponse = await fetch(
            `https://beyondchats-3.onrender.com/job-status/${data.job_id}`
          );
          ...
          if (statusData.status === "completed") {
            ...
            const articleResponse = await fetch(
              `https://beyondchats-3.onrender.com/articles/${enhancedArticleId}`
            );
